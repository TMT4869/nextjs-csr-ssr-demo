...
const translations = {
  en: {
    ...
    // Footer
    'footer.copyright': '© 2025 Next.js CSR vs SSR Demo. Built with Next.js 14+ and TypeScript.',
    ...
    'csr.loadingNote': '💡 Note: Users see a blank page/loading for 3 seconds until API returns data. Then interaction is very smooth!',
    'csr.error': '❌ Error: ',
    'csr.author': 'By: ',
    ...
    'ssr.seoNote': '💡 Note: Although API takes 2 seconds, users see content immediately because data was pre-rendered on server!',
    ...
    'clientBlog.success': '✅ CSR: Blog data loaded successfully ({count} posts)',
  ...
  vi: {
    ...
    // Hero Section
    'hero.title': 'CSR vs SSR',
    'hero.description': 'Khám phá sự khác biệt giữa Client-Side Rendering và Server-Side Rendering trong Next.js thông qua các demo thực tế',
    'hero.nextjs': '🚀 Next.js 14+',
    'hero.performance': '⚡ Performance Demo',
    'hero.optimization': '🔧 Optimization Techniques',
    ...
    'demo.csr.title': 'CSR Demo',
    'demo.csr.description': 'Client-Side Rendering với loading states và 3s delay',
    'demo.ssr.title': 'SSR Demo',
    'demo.ssr.description': 'Server-Side Rendering với 2s delay để demo performance',
    'demo.comparison.title': 'So sánh chi tiết',
    'demo.comparison.description': 'Phân tích chi tiết performance và use cases',
    ...
    // Footer
    'footer.copyright': '© 2025 Next.js CSR vs SSR Demo. Được xây dựng với Next.js 14+ và TypeScript.',
    
    // Blog Pages
    'blog.title': 'TechBlog (Tối ưu)',
    'blog.description': 'Demo tối ưu hóa: Trang load nhanh + Data stream riêng biệt',
    'blog.instantLoad': '⚡ Instant page load',
    'blog.suspenseStreaming': '🔄 Suspense streaming',
    'blog.optimizedUX': '🚀 Optimized UX',
    'blog.strategy': '🔧 Optimized Strategy',
    ...
    'csr.loadingNote': '💡 Lưu ý: Người dùng thấy trang trắng/loading trong 3 giây cho đến khi API trả về dữ liệu. Sau đó tương tác rất mượt mà!',
    'csr.error': '❌ Lỗi: ',
    'csr.author': 'Bởi: ',
    'csr.codeExample': '💻 Code Example',
    ...
    'ssr.author': 'Bởi: ',
    'ssr.codeExample': '💻 Code Example',
    'ssr.seoNote': '💡 Lưu ý: Mặc dù API mất 2 giây nhưng người dùng thấy nội dung ngay lập tức vì dữ liệu đã được render sẵn trên server!',
    'ssr.seoBenefits': '🚀 SEO Benefits',
    'ssr.seoDescription': 'Trang này có HTML hoàn chỉnh với dữ liệu khi tải, rất tốt cho SEO!',
    'ssr.viewSource': 'View Page Source để thấy dữ liệu đã có trong HTML',
    
    // Comparison Page
    'comp.title': 'So sánh CSR vs SSR',
    'comp.subtitle': 'Phân tích chi tiết ưu nhược điểm của từng phương pháp rendering',
    ...
    'comp.hybridDesc': 'Next.js 14+ App Router cho phép bạn kết hợp cả CSR và SSR trong cùng một ứng dụng. Sử dụng SSR cho các trang cần SEO và CSR cho các phần tương tác.',
    'comp.serverComponents': 'Server Components',
    ...
    'blogList.noResultsDesc': 'Thử thay đổi từ khóa tìm kiếm hoặc danh mục khác',
    ...
    'clientBlog.success': '✅ CSR: Dữ liệu blog đã tải thành công ({count} bài viết)',
    'clientBlog.author': '👤 {author}',
    'clientBlog.date': '📅 {date}',
    ...
    'loading.serverFetching': 'Server đang fetch dữ liệu với 5s delay. Đây là demo blocking SSR - toàn bộ trang phải chờ server xử lý xong.',
    'loading.ssrProcessing': 'SSR Processing...',
    ...
    'mock.csrContent': 'Đây là dữ liệu được fetch từ client side sau khi component đã mount.',
    'mock.ssrContent': 'Đây là dữ liệu được fetch từ server side trước khi gửi HTML về client.',
